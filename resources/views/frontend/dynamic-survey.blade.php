...
<head>
    ...
    <!-- icon logo -->
    <link rel="icon" href="{{ asset('image/logo-unmaris.png') }}" type="image/x-icon">
    <style>
...
<body class="bg-gray-50 text-gray-800 antialiased font-sans">
    <div class="max-w-md mx-auto bg-white min-h-screen shadow-2xl flex flex-col relative">
        ...
        <div class="p-6 flex-1 -mt-8 relative z-20">
            ...
            {{-- LOGIKA: JIKA USER SUDAH PERNAH MENGISI --}}
            @if($alreadySubmitted)
                <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 text-center space-y-4">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">
                        Anda sudah mengisi formulir survei ini sebelumnya. Terima kasih telah membantu meningkatkan kualitas layanan Universitas Stella Maris.
                    </p>
                    <div class="pt-4">
                        <p class="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Identitas Perangkat Terdaftar</p>
                        <p class="text-xs font-mono text-gray-500 mt-1">{{ request()->ip() }}</p>
                    </div>
                </div>
            @else
                {{-- TAMPILKAN FORM HANYA JIKA BELUM MENGISI --}}
